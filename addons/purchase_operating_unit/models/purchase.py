...
class PurchaseOrder(models.Model):
    ...
    def _onchange_picking_type_id(self):
        ...
        if self.picking_type_id:
            types = type_obj.search([('id', '=', self.picking_type_id.id)])
            if types:
                self.operating_unit_id = self.picking_type_id.warehouse_id and self.picking_type_id.warehouse_id and self.picking_type_id.warehouse_id.operating_unit_id and self.picking_type_id.warehouse_id.operating_unit_id.id
