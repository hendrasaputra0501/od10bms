...
class AccountBankStatementLine(models.Model):
    ...
    # MODIFY BANK RECONCILIATION WHEN IT WAS FROM TRANSFER BETWEEN OPERATIONG UNIT
    def process_reconciliation(self, counterpart_aml_dicts=None, payment_aml_rec=None, new_aml_dicts=None):
        ...
        for aml_rec in payment_aml_rec:
            ...
            aml_rec.with_context(check_move_validity=False).sudo().write({'statement_id': self.statement_id.id})
            aml_rec.move_id.sudo().write({'statement_line_id': self.id})
