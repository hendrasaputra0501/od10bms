...
class TestKpiData(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.kpi2 = cls.env['mis.report.kpi'].create(dict(
            report_id=report.id,
            name='k2',
            description='kpi 2',
            expression='AccountingNone',
        ...
        cls.kd11 = cls.env['mis.kpi.data.test.item'].create(dict(
            kpi_expression_id=cls.expr1.id,
            date_from='2017-05-01',
            date_to='2017-05-10',
            amount=10,
        ))
        cls.kd12 = cls.env['mis.kpi.data.test.item'].create(dict(
            kpi_expression_id=cls.expr1.id,
            date_from='2017-05-11',
            date_to='2017-05-20',
            amount=20,
        ))
        cls.kd13 = cls.env['mis.kpi.data.test.item'].create(dict(
            kpi_expression_id=cls.expr1.id,
            date_from='2017-05-21',
            date_to='2017-05-25',
            amount=30,
        ))
        cls.kd21 = cls.env['mis.kpi.data.test.item'].create(dict(
